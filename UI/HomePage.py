...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(0, 85, 800, 55))
        self.label.setMinimumSize(QtCore.QSize(519, 43))
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        # FIX: buttons start at y=150 (clear of logo+title), centered horizontally (x=190, w=420)
        self.LRP = QtWidgets.QPushButton(self.centralwidget)
        self.LRP.setGeometry(QtCore.QRect(190, 150, 420, 51))
        ...
        self.MR.setGeometry(QtCore.QRect(190, 210, 420, 51))
        ...
        self.JV.setGeometry(QtCore.QRect(190, 270, 420, 51))
        ...
        self.SC.setGeometry(QtCore.QRect(190, 330, 420, 51))
        ...
        self.PS_button.setGeometry(QtCore.QRect(190, 390, 420, 51))
        ...
        self.AC.setGeometry(QtCore.QRect(190, 450, 420, 51))
        ...
        self.T0S.setGeometry(QtCore.QRect(190, 510, 420, 51))
        ...
        self.DF.setGeometry(QtCore.QRect(190, 570, 420, 51))
        ...
        self.DP.setGeometry(QtCore.QRect(190, 630, 420, 51))
        ...
        self.AP.setGeometry(QtCore.QRect(190, 690, 420, 51))
        self.AP.setStyleSheet("font: 20pt \".AppleSystemUIFont\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:32pt; font-weight:600;\">pyADR</span></p></body></html>"))
